module "archlinux" {
  source                               = "./archlinux"
  enable_archlinux_latest_x86_64_qcow2 = module.archlinux.enable_archlinux_latest_x86_64_qcow2
  enable_archlinux_latest_x86_64_raw   = module.archlinux.enable_archlinux_latest_x86_64_raw
}
