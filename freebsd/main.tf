...
resource "openstack_images_image_v2" "freebsd-130-aarch64-raw" {
  ...
  name   = "freebsd-13.0-BETA4-arm64-aarch64.raw"
  local_file_path = pathexpand("~/.terraform/image_cache/FreeBSD-13.0-BETA4-arm64-aarch64.raw")
  container_format = "bare"
  disk_format = "raw"
  visibility = "public"
  depends_on = [
...
resource "openstack_images_image_v2" "freebsd-130-aarch64-qcow2" {
  ...
  name   = "freebsd-13.0-BETA4-arm64-aarch64.qcow2"
  local_file_path = pathexpand("~/.terraform/image_cache/FreeBSD-13.0-BETA4-arm64-aarch64.qcow2")
  container_format = "bare"
  disk_format = "qcow2"
  visibility = "public"
  depends_on = [
